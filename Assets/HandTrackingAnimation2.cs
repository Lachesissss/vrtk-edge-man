...
public class HandTrackingAnimation2 : MonoBehaviour
{
    ...
    public void LateUpdate()
    {
        if (handTrackingReady)
        {
            ...
            LeftHandThumb1.localPosition = LeftHandThumb1.parent.InverseTransformPoint(LeftHandPos[0] + playerPos);
            Debug.Log(LeftHandThumb1.parent.transform.position.ToString() + ' ' + LeftHandPos[0].ToString());
            LeftHandThumb1.localRotation = Quaternion.Inverse(LeftHandThumb1.parent.transform.rotation) * LeftHandRot[0] * playerRot;
            LeftHandThumb2.localPosition = LeftHandThumb2.parent.InverseTransformPoint(LeftHandPos[1] + playerPos);
            LeftHandThumb2.localRotation = Quaternion.Inverse(LeftHandThumb2.parent.transform.rotation) * LeftHandRot[1] * playerRot;
            LeftHandThumb3.localPosition = LeftHandThumb3.parent.InverseTransformPoint(LeftHandPos[2] + playerPos) ;
            LeftHandThumb3.localRotation = Quaternion.Inverse(LeftHandThumb3.parent.transform.rotation) * LeftHandRot[2] * playerRot;
            LeftHandThumb4.localPosition = LeftHandThumb4.parent.InverseTransformPoint(LeftHandPos[3] + playerPos);
            LeftHandThumb4.localRotation = Quaternion.Inverse(LeftHandThumb4.parent.transform.rotation) * LeftHandRot[3] * playerRot;

            LeftHandIndex1.localPosition = LeftHandIndex1.parent.InverseTransformPoint(LeftHandPos[5] + playerPos);
            LeftHandIndex1.localRotation = Quaternion.Inverse(LeftHandIndex1.parent.transform.rotation) * LeftHandRot[5] * playerRot;
            LeftHandIndex2.localPosition = LeftHandIndex2.parent.InverseTransformPoint(LeftHandPos[6] + playerPos);
            LeftHandIndex2.localRotation = Quaternion.Inverse(LeftHandIndex2.parent.transform.rotation) * LeftHandRot[6] * playerRot;
            LeftHandIndex3.localPosition = LeftHandIndex3.parent.InverseTransformPoint(LeftHandPos[7] + playerPos);
            LeftHandIndex3.localRotation = Quaternion.Inverse(LeftHandIndex3.parent.transform.rotation) * LeftHandRot[7] * playerRot;
            LeftHandIndex4.localPosition = LeftHandIndex4.parent.InverseTransformPoint(LeftHandPos[8] + playerPos);
            LeftHandIndex4.localRotation = Quaternion.Inverse(LeftHandIndex4.parent.transform.rotation) * LeftHandRot[8] * playerRot;

            LeftHandMiddle1.localPosition = LeftHandMiddle1.parent.InverseTransformPoint(LeftHandPos[10] + playerPos);
            LeftHandMiddle1.localRotation = Quaternion.Inverse(LeftHandMiddle1.parent.transform.rotation) * LeftHandRot[10] * playerRot;
            LeftHandMiddle2.localPosition = LeftHandMiddle2.parent.InverseTransformPoint(LeftHandPos[11] + playerPos);
            LeftHandMiddle2.localRotation = Quaternion.Inverse(LeftHandMiddle2.parent.transform.rotation) * LeftHandRot[11] * playerRot;
            LeftHandMiddle3.localPosition = LeftHandMiddle3.parent.InverseTransformPoint(LeftHandPos[12] + playerPos);
            LeftHandMiddle3.localRotation = Quaternion.Inverse(LeftHandMiddle3.parent.transform.rotation) * LeftHandRot[12] * playerRot;
            LeftHandMiddle4.localPosition = LeftHandMiddle4.parent.InverseTransformPoint(LeftHandPos[13] + playerPos);
            LeftHandMiddle4.localRotation = Quaternion.Inverse(LeftHandMiddle4.parent.transform.rotation) * LeftHandRot[13] * playerRot;

            LeftHandRing1.localPosition = LeftHandRing1.parent.InverseTransformPoint(LeftHandPos[15] + playerPos);
            LeftHandRing1.localRotation = Quaternion.Inverse(LeftHandRing1.parent.transform.rotation) * LeftHandRot[15] * playerRot;
            LeftHandRing2.localPosition = LeftHandRing2.parent.InverseTransformPoint(LeftHandPos[16] + playerPos);
            LeftHandRing2.localRotation = Quaternion.Inverse(LeftHandRing2.parent.transform.rotation) * LeftHandRot[16] * playerRot;
            LeftHandRing3.localPosition = LeftHandRing3.parent.InverseTransformPoint(LeftHandPos[17] + playerPos);
            LeftHandRing3.localRotation = Quaternion.Inverse(LeftHandRing3.parent.transform.rotation) * LeftHandRot[17] * playerRot;
            LeftHandRing4.localPosition = LeftHandRing4.parent.InverseTransformPoint(LeftHandPos[18] + playerPos);
            LeftHandRing4.localRotation = Quaternion.Inverse(LeftHandRing4.parent.transform.rotation) * LeftHandRot[18] * playerRot;

            LeftHandPinky1.localPosition = LeftHandPinky1.parent.InverseTransformPoint(LeftHandPos[20] + playerPos);
            LeftHandPinky1.localRotation = Quaternion.Inverse(LeftHandPinky1.parent.transform.rotation) * LeftHandRot[20] * playerRot;
            LeftHandPinky2.localPosition = LeftHandPinky2.parent.InverseTransformPoint(LeftHandPos[21] + playerPos);
            LeftHandPinky2.localRotation = Quaternion.Inverse(LeftHandPinky2.parent.transform.rotation) * LeftHandRot[21] * playerRot;
            LeftHandPinky3.localPosition = LeftHandPinky3.parent.InverseTransformPoint(LeftHandPos[22] + playerPos);
            LeftHandPinky3.localRotation = Quaternion.Inverse(LeftHandPinky3.parent.transform.rotation) * LeftHandRot[22] * playerRot;
            LeftHandPinky4.localPosition = LeftHandPinky4.parent.InverseTransformPoint(LeftHandPos[23] + playerPos);
            LeftHandPinky4.localRotation = Quaternion.Inverse(LeftHandPinky4.parent.transform.rotation) * LeftHandRot[23] * playerRot;
